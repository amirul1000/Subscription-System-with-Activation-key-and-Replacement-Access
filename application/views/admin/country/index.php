...
<table class="table table-striped table-bordered">
    ...
    <tr>
		...
		<td>
            <a href="<?php echo site_url('admin/country/details/'.$c['id']); ?>"  class="action-icon"> <i class="fa fa-eye"></i></a>
            <a href="<?php echo site_url('admin/country/save/'.$c['id']); ?>" class="action-icon"> <i class="fa fa-edit"></i></a>
            <a href="<?php echo site_url('admin/country/remove/'.$c['id']); ?>" onClick="return confirm('Are you sure to delete this item?');" class="action-icon"> <i class="fa fa-trash"></i></a>
        </td>
    </tr>
	<?php } ?>
</table>
