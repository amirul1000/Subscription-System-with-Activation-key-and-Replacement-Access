...
<div class="form-group"> 
          ...
          <div class="col-md-8"> 
           <input type="datetime-local" name="expiration_date_time"  id="expiration_date_time"  value="<?php echo ($this->input->post('expiration_date_time') ? $this->input->post('expiration_date_time') : $subscription['expiration_date_time']); ?>" class="form-control-static datepicker"/> 
          </div> 
           </div>
