...
<td><?php echo $c['used_by_activation_key']; ?></td>
		...
		<td>
            <a href="<?php echo site_url('admin/data_key/details/'.$c['id']); ?>"  class="action-icon"> <i class="fa fa-eye"></i></a>
            <a href="<?php echo site_url('admin/data_key/save/'.$c['id']); ?>" class="action-icon"> <i class="fa fa-edit"></i></a>
            <a href="<?php echo site_url('admin/data_key/remove/'.$c['id']); ?>" onClick="return confirm('Are you sure to delete this item?');" class="action-icon"> <i class="fa fa-trash"></i></a>
        </td>
    </tr>
	<?php } ?>
</table>
