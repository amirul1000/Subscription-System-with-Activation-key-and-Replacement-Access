...
<td><?php echo $c['status']; ?></td>
		...
		<td>
            <a href="<?php echo site_url('admin/users/details/'.$c['id']); ?>"  class="action-icon"> <i class="fa fa-eye"></i></a>
            <a href="<?php echo site_url('admin/users/save/'.$c['id']); ?>" class="action-icon"> <i class="fa fa-edit"></i></a>
            <a href="<?php echo site_url('admin/users/remove/'.$c['id']); ?>" onClick="return confirm('Are you sure to delete this item?');" class="action-icon"> <i class="fa fa-trash"></i></a>
        </td>
    </tr>
	<?php } ?>
</table>
