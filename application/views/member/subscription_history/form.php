<a  href="<?php echo site_url('member/subscription_history/index'); ?>" class="btn btn-info"><i class="arrow_left"></i> List</a>
<h5 class="font-20 mt-15 mb-1"><?php if($id<0){echo "Save";}else { echo "Update";} echo " "; echo str_replace('_',' ','Subscription_history'); ?></h5>
<!--Form to save data-->
<?php echo form_open_multipart('member/subscription_history/save/'.$subscription_history['id'],array("class"=>"form-horizontal")); ?>
<div class="card">
   <div class="card-body">
        ...
        <div class="form-group"> 
         ...
         <div class="col-md-8"> 
          <?php 
             ...
             $dataArr = $this->CI->Subscription_model->get_all_subscription(); 
          ?> 
          <select name="subscription_id"  id="subscription_id"  class="form-control"/> 
            ...
            <?php 
             ...
             {  
            ?> 
            <option value="<?=$dataArr[$i]['id']?>" <?php if($subscription_history['subscription_id']==$dataArr[$i]['id']){ echo "selected";} ?>><?=$dataArr[$i]['subscriptionid']?></option> 
            <?php 
             } 
            ?> 
          </select> 
