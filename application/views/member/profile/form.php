...
<a href="<?php echo site_url('member/profile/index'); ?>"
	class="btn btn-info">List</a>
<?php echo form_open_multipart('member/profile/save/'.$users['id'],array("class"=>"form-horizontal")); ?>
...
<div class="form-group">
	...
	<div class="col-md-8">
		...
		<option value="">--Select--</option>
                  <?php
                for ($i = 0; $i < count((array)$dataArr); $i ++) {
                    ?>
